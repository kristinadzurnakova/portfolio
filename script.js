...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (track) {
        ...
        window.addEventListener('load', () => {
            ...
            // --- UPRAVENÝ TOUCH / SWIPE PRE MOBIL ---
            let touchStartX = 0;
            ...
            track.addEventListener('touchmove', (e) => {
                ...
                // Výpočet rýchlosti pre plynulý dojazd (momentum)
                if (deltaTime > 0) {
                    touchVelocity = deltaX / deltaTime;
                }

                // Koeficient 1.2 zvyšuje odozvu na pohyb prsta
                scrollPos = touchStartScroll + (touchStartX - currentX) * 1.2;
            ...
            track.addEventListener('touchend', (e) => {
                // Pridanie zotrvačnosti podľa rýchlosti švihu
                if (Math.abs(touchVelocity) > 0.2) {
                    scrollPos += touchVelocity * 150; 
                }
